...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("haos", "HAOS Control Plane: constructor de engenharia, status e dispatch de equipes",
               "Tools & Skills", args_hint="[constructor <meta> | status | dispatch | plan <meta>]",
               subcommands=("constructor", "status", "dispatch", "plan"),
               busy_policy="dispatch"),
